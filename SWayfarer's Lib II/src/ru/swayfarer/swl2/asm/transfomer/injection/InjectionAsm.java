 ...
 * Для этого укажите последним параметром {@link IReference} с названием returnRef, либо отмеченный аннотацией {@link ReturnRef}
 ...
 * Проще говоря, чтобы заставить void сделать return, необходимо вызвать {@link IReference#setValue(Object)} и передать что угодно
 * 
