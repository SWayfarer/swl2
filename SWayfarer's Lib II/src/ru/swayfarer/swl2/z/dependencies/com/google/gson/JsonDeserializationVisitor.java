 ...
 * implementations. This class exposes the {@link #getTarget()} method which
 * returns the class that was visited by this object.
 *
...
abstract class JsonDeserializationVisitor<T> implements ObjectNavigator.Visitor {
	...
	public JsonDeserializationVisitor(JsonElement json, ObjectNavigatorFactory factory, ObjectConstructor objectConstructor, TypeAdapter typeAdapter, ParameterizedTypeHandlerMap<JsonDeserializer<?>> deserializers,
