...
final class JsonObjectDeserializationVisitor<T> extends JsonDeserializationVisitor<T> {
	...
	public JsonObjectDeserializationVisitor(JsonElement json, Type type, ObjectNavigatorFactory factory, ObjectConstructor objectConstructor, TypeAdapter typeAdapter, ParameterizedTypeHandlerMap<JsonDeserializer<?>> deserializers,
	...
	public JsonObjectDeserializationVisitor(JsonElement json, Type type, ObjectNavigatorFactory factory, ObjectConstructor objectConstructor, T instance, TypeAdapter typeAdapter, ParameterizedTypeHandlerMap<JsonDeserializer<?>> deserializers, JsonDeserializationContext context)
	{
		super(json, factory, objectConstructor, typeAdapter, deserializers, context);
	...
	{
		// should not be called since this case should invoke
		// JsonPrimitiveDeserializationVisitor
		throw new IllegalStateException();
	}
	...
	public void visitPrimitiveField(Field f, Object obj)
	{
		try
		{
			...
			else
			{
				...
				// For other primitive types, any value created during default
